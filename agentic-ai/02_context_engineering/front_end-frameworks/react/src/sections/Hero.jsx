    ...
    return (
        ...
        >
            <div className="relative z-10 flex flex-col items-center max-w-4xl w-full">
                ...
                {/* Stats */}
                <ul className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-8 w-full">
                    {StatData.map((stat) => (
                        <li key={stat.id} className="p-6 rounded-xl border border-slate-800 bg-slate-950 shadow-xl shadow-slate-950/40">
